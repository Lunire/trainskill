        ...
        <form action="/course_edit" method="post">
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center">
                    ...
                    <input type="file" id="image1" name="image1" class="d-none" value="<?= $activity['description'] ?>" required>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    ...
                    <input type="file" id="image2" name="image2" class="d-none" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="file" id="image3" name="image3" class="d-none" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="file" id="image4" name="image4" class="d-none" required>
                </div>
            </div>

            <div class="mt-4 text-center">
                <button type="submit" class="btn btn-success w-50">บันทึกการแก้ไข</button>
            </div>
        </form>
    </div>
</div>